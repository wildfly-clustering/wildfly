...
public enum AnyField implements ProtoStreamMarshaller<Object>, Field {
    ...
    STRING(String.class) {
        ...
        public OptionalInt size(ImmutableSerializationContext context, Object value) {
            String string = (String) value;
            return OptionalInt.of(Predictable.stringSize(string));
        }
    },
    ...
    PROXY(Void.class) {
        ...
        public Object readFrom(ImmutableSerializationContext context, RawProtoStreamReader reader) throws IOException {
            ...
            for (int i = 0; i < interfaceClasses.length; ++i) {
                interfaceClasses[i] = (Class<?>) ObjectMarshaller.INSTANCE.readFrom(context, reader);
            }
        ...
        public void writeTo(ImmutableSerializationContext context, RawProtoStreamWriter writer, Object value) throws IOException {
            ...
            for (Class<?> interfaceClass : interfaceClasses) {
                ObjectMarshaller.INSTANCE.writeTo(context, writer, interfaceClass);
            }
    ...
    THROWABLE(Throwable.class) {
        ...
        public Object readFrom(ImmutableSerializationContext context, RawProtoStreamReader reader) throws IOException {
            ...
            String message = (String) STRING.readFrom(context, reader);

            Throwable cause = (Throwable) ObjectMarshaller.INSTANCE.readFrom(context, reader);

            Throwable exception = createThrowable(targetClass.asSubclass(Throwable.class), message, cause);
        ...
        public void writeTo(ImmutableSerializationContext context, RawProtoStreamWriter writer, Object value) throws IOException {
            ...
            ClassMarshaller.ANY.writeTo(context, writer, exception.getClass());

            String message = exception.getMessage();
            Throwable cause = exception.getCause();
            if ((cause != null) && cause.toString().equals(message)) {
                // Avoid serializing redundant message
                message = null;
            }
            STRING.writeTo(context, writer, message);
    ...
    static Throwable createThrowable(Class<? extends Throwable> targetClass, String message, Throwable cause) throws IOException {
        try {
            if (cause != null) {
                try {
                    return (message != null) ? targetClass.getConstructor(String.class, Throwable.class).newInstance(message, cause) : targetClass.getConstructor(Throwable.class).newInstance(cause);
                } catch (NoSuchMethodException e) {
                    // Retry with different constructor
                }
            }
            Throwable exception = (message != null) ? targetClass.getConstructor(String.class).newInstance(message) : targetClass.getConstructor().newInstance();
            if (cause != null) {
