...
public interface SessionManagerFactoryConfiguration extends WebDeploymentConfiguration {
    ...
    /**
     * Returns the default session timeout. If null, the session manager should defer to the ServletContext for this value.
     * @return a duration after which sessions will timeout.
     */
    Integer getDefaultSessionTimeout();
