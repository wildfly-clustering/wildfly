...
public class InfinispanLegacySessionManagementProviderFactory implements LegacySessionManagementProviderFactory {
    ...
    public DistributableSessionManagementProvider createSessionManagerProvider(ReplicationConfig config) {
        ...
        ServiceName replicationConfigServiceName = ServiceName.parse((replicationConfigCacheName != null) ? replicationConfigCacheName : "web");
        ...
        return new InfinispanSessionManagementProvider(configuration);
    }
}
