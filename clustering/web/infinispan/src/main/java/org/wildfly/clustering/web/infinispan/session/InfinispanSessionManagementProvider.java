...
import org.wildfly.clustering.web.infinispan.routing.InfinispanRouteLocatorServiceConfigurator;
...
public class InfinispanSessionManagementProvider implements DistributableSessionManagementProvider {
    ...
    public InfinispanSessionManagementProvider(InfinispanSessionManagementConfiguration configuration) {
    ...
    public CapabilityServiceConfigurator getRouteLocatorServiceConfigurator(WebDeploymentConfiguration config) {
        return new InfinispanRouteLocatorServiceConfigurator(this.configuration, config);
    }
}
