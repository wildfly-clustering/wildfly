...
public class InfinispanRouteLocatorServiceConfigurator extends SimpleServiceNameProvider implements CapabilityServiceConfigurator, InfinispanRouteLocatorConfiguration, Supplier<RouteLocator> {
    ...
    public InfinispanRouteLocatorServiceConfigurator(InfinispanSessionManagementConfiguration managementConfiguration, WebDeploymentConfiguration deploymentConfiguration) {
        super(ServiceName.parse(WebDeploymentRequirement.ROUTE_LOCATOR.resolve(deploymentConfiguration.getDeploymentName())));
    ...
    public RoutingStrategy getStrategy() {
        return this.managementConfiguration.getRoutingStrategy();
    }
}
