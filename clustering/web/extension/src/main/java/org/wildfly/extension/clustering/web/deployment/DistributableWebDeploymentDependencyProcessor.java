...
public class DistributableWebDeploymentDependencyProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext context) throws DeploymentUnitProcessingException {
        ...
        if (((warMetaData != null) && (warMetaData.getMergedJBossWebMetaData().getDistributable() != null)) || (sharedConfig != null)) {
            ...
            if (management != null) {
                ...
                String deploymentName = (parentUnit != null) ? parentUnit.getParent().getName() + "." + unit.getName() : unit.getName();
                ...
                builder.setInstance(Service.newInstance(injector, management)).setInitialMode(ServiceController.Mode.ON_DEMAND).install();
