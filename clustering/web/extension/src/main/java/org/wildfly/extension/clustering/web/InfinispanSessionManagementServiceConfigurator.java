 ...
 * @author Paul Ferraro
 */
public class InfinispanSessionManagementServiceConfigurator extends SessionManagementServiceConfigurator implements InfinispanSessionManagementConfiguration {
    ...
    public DistributableSessionManagementProvider get() {
        return new InfinispanSessionManagementProvider(this);
    }
