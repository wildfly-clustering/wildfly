...
public class DistributableWebXMLParser extends PersistentResourceXMLParser {
    ...
    public PersistentResourceXMLDescription getParserDescription() {
        return builder(DistributableWebResourceDefinition.PATH, this.schema.getNamespaceUri()).setUseElementsForGroups(true)
                ...
                .addChild(DistributableWebResourceDefinition.Attribute.DEFAULT_SESSION_MANAGEMENT.getDefinition(), new AttributeXMLBuilderOperator()
                ...
                .addChild(DistributableWebResourceDefinition.Attribute.DEFAULT_SSO_MANAGEMENT.getDefinition(), new AttributeXMLBuilderOperator(InfinispanSSOManagementResourceDefinition.Attribute.class)
